...
class Players with ChangeNotifier {
  ...
  addPlayer(String name, String position, String image) async {
    ...
    Uri url = Uri.parse(
        "https://fir-flutter-4f93c-default-rtdb.firebaseio.com/players.json");
  ...
  editPlayer(String id, String name, String position, String image) async {
    Uri url = Uri.parse(
        "https://fir-flutter-4f93c-default-rtdb.firebaseio.com/$id.json");
  ...
  deletePlayer(String id) async {
    Uri url = Uri.parse(
        "https://fir-flutter-4f93c-default-rtdb.firebaseio.com/players/$id.json");
